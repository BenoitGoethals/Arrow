...
class FriendlyProvider(CotMessageProvider):
    ...
    def get_messages(self) -> list[CotEntry]:
        return [
            ...
            _e(
                category="Friendly",
                label="Armour — TITAN-1",
                uid="SIM.TITAN-1",
                cot_type="a-f-G-U-C-A",
                callsign="TITAN-1",
                lat=50.8490,
                lon=4.3460,
                hae=70.0,
...
class HostileProvider(CotMessageProvider):
    ...
    def get_messages(self) -> list[CotEntry]:
        ...
        return [
            ...
            _h(
                label="Armour T-72 — HOT-ARM-1",
                uid="SIM.HOT-ARM-1",
                cot_type="a-h-G-U-C-A",
                lat=50.8430,
                lon=4.3510,
                hae=70.0,
                speed=4.2,
            ...
            _h(
                label="Mech Infantry — HOT-MECH-1",
                uid="SIM.HOT-MECH-1",
                cot_type="a-h-G-U-C-I-Z",
                lat=50.8420,
                lon=4.3530,
                hae=72.0,
                speed=6.0,
            ...
            _h(
                label="Artillery — HOT-ARTY-1",
                uid="SIM.HOT-ARTY-1",
                cot_type="a-h-G-U-C-F",
                lat=50.8400,
                lon=4.3600,
                hae=80.0,
                speed=0.0,
            ...
            _h(
                label="Air Defence — HOT-AD-1",
                uid="SIM.HOT-AD-1",
                cot_type="a-h-G-U-C-D",
                lat=50.8410,
                lon=4.3580,
                hae=78.0,
                speed=0.0,
            ...
            _h(
                label="Sniper — HOT-SNI-1",
                uid="SIM.HOT-SNI-1",
                cot_type="a-h-G-U-C-I-S",
                lat=50.8460,
                lon=4.3470,
                hae=82.0,
                speed=0.0,
            ...
            _h(
                label="Recon — HOT-REC-1",
                uid="SIM.HOT-REC-1",
                cot_type="a-h-G-U-C-R",
                lat=50.8455,
                lon=4.3510,
                hae=73.0,
                speed=3.5,
...
class PoiProvider(CotMessageProvider):
    ...
    def get_messages(self) -> list[CotEntry]:
        def _p(**kw: object) -> CotEntry:
            return _e(category="POI", cot_type="a-n-G-I-N", speed=0.0, course=0.0, **kw)
        ...
        return [
            ...
            _p(
                label="Medical Aid Station — BAS-1",
                uid="SIM.POI-MED-1",
                callsign="BAS-1",
                lat=50.8490,
                lon=4.3500,
...
class JsonFileCotProvider(CotMessageProvider):
    ...
    def get_messages(self) -> list[CotEntry]:
        ...
        for item in items:
            try:
                entries.append(
                    CotEntry(**{k: v for k, v in item.items() if k in _fields})
                )
