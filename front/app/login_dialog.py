...
class LoginDialog(QDialog):
    ...
    def _build_ui(self):
        ...
        subtitle.setStyleSheet("color:#484f58;font-size:9px;font-weight:600;letter-spacing:3px;")
        ...
        fl.addWidget(QLabel("Arrow Tactical Platform  ·  Secure Channel",
...
def _lbl(text: str) -> QLabel:
    lbl = QLabel(text)
    lbl.setStyleSheet("color:#8b949e;font-size:9px;font-weight:600;letter-spacing:1.5px;")
    return lbl
